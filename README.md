...
→ [miniscript-visualizer.pandul.workers.dev](https://miniscript-visualizer.pandul.workers.dev/)
...
- Interactive diagram: edit conditions directly on the tree, drag nodes, pan, zoom, export as PNG
